...
type ProductServiceInterface interface {
	...
	GetAllProduct(ctx context.Context, params *struct{ model.ParamsProductModel }) ([]model.GetProductModel, error)
	GetProductByID(ctx context.Context, id int) (model.GetProductModel, error)
}
